...
import com.example.fabio.barcode.Compilazione;
 ...
 */
public final class Articolo extends AppCompatActivity implements BarcodeGraphicTracker.BarcodeDetectorListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        mGraphicOverlay = (GraphicOverlay<BarcodeGraphic>) findViewById(R.id.graphicOverlay2);
...
//        finish();
        if (data != null) {
            ...
            e.apply();
            e.commit();
            startActivity(new Intent(getApplicationContext(), Compilazione.class));
